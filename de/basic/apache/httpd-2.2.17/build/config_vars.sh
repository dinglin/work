...
if test -f ${DESTDIR}/usr/local/httpd-2.2.x/bin/apr-1-config; then
   APR_CONFIG=${DESTDIR}/usr/local/httpd-2.2.x/bin/apr-1-config
   APU_CONFIG=${DESTDIR}/usr/local/httpd-2.2.x/bin/apu-1-config
else
...
installbuilddir="/usr/local/httpd-2.2.x/build"
