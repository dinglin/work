...
"dsn"=>"mysql:host=10.20.3.80;port=3306;dbname=propertys_db",
"username" => "readonly_v2",
"password" => "aNjuKe9dx1Pdw",
"init_attributes" => array(),
"init_statements" => array("SET CHARACTER SET utf8","SET NAMES utf8"),
...
"dsn"=>"mysql:host=10.20.3.80;port=3306;dbname=propertys_db_04",
"username" => "readonly_v2",
"password" => "aNjuKe9dx1Pdw",
"init_attributes" => array(),
"init_statements" => array("SET CHARACTER SET utf8","SET NAMES utf8"),
...
"dsn"=>"mysql:host=10.20.3.80;port=3306;dbname=propertys_other_db",
"username" => "readonly_v2",
"password" => "aNjuKe9dx1Pdw",
"init_attributes" => array(),
"init_statements" => array("SET CHARACTER SET utf8","SET NAMES utf8"),
...
"dsn"=>"mysql:host=10.20.3.80;port=3306;dbname=propertys_sh_db",
"username" => "readonly_v2",
"password" => "aNjuKe9dx1Pdw",
"init_attributes" => array(),
"init_statements" => array("SET CHARACTER SET utf8","SET NAMES utf8"),
...
"dsn"=>"mysql:host=10.20.3.80;port=3306;dbname=ark_db",
"username" => "readonly_v2",
"password" => "aNjuKe9dx1Pdw",
"init_attributes" => array(),
"init_statements" => array("SET CHARACTER SET utf8","SET NAMES utf8"),
...
"dsn"=>"mysql:host=10.20.3.80;port=3307;dbname=rent_forum_db",
...
"dsn"=>"mysql:host=10.20.3.80;port=3307;dbname=rent_crm_db",
"username" => "anjuke_triger",
"password" => "anjuke_triger",
"init_attributes" => array(),
"init_statements" => array("SET CHARACTER SET utf8","SET NAMES utf8"),
...
"dsn"=>"mysql:host=10.20.3.80;port=3307;dbname=hzstats_db",
"username" => "anjuke_triger",
"password" => "anjuke_triger",
"init_attributes" => array(),
"init_statements" => array("SET CHARACTER SET utf8","SET NAMES utf8"),
...
"dsn"=>"mysql:host=10.20.3.80;port=3306;dbname=hz_dw_stats",
"username" => "readonly_v2",
"password" => "aNjuKe9dx1Pdw",
"init_attributes" => array(),
"init_statements" => array("SET CHARACTER SET utf8","SET NAMES utf8"),
...
"dsn"=>"mysql:host=10.20.3.80;port=3306;dbname=image_db",
"username" => "readonly_v2",
"password" => "aNjuKe9dx1Pdw",
"init_attributes" => array(),
"init_statements" => array("SET CHARACTER SET utf8","SET NAMES utf8"),
...
"dsn"=>"mysql:host=10.20.3.80;port=3306;dbname=image_ext_db",
"username" => "readonly_v2",
"password" => "aNjuKe9dx1Pdw",
"init_attributes" => array(),
"init_statements" => array("SET CHARACTER SET utf8","SET NAMES utf8"),
...
"dsn"=>"mysql:host=10.20.3.80;port=3307;dbname=rent_jobs_db",
"username" => "anjuke_triger",
"password" => "anjuke_triger",
"init_attributes" => array(),
"init_statements" => array("SET CHARACTER SET utf8","SET NAMES utf8"),
...
"dsn"=>"mysql:host=10.20.3.80;port=3307;dbname=rent_logs_db",
"username" => "anjuke_triger",
"password" => "anjuke_triger",
"init_attributes" => array(),
"init_statements" => array("SET CHARACTER SET utf8","SET NAMES utf8"),
...
"dsn"=>"mysql:host=10.20.3.80;port=3306;dbname=ppc_db",
"username" => "readonly_v2",
"password" => "aNjuKe9dx1Pdw",
"init_attributes" => array(),
"init_statements" => array("SET CHARACTER SET utf8","SET NAMES utf8"),
...
"dsn"=>"mysql:host=10.20.3.80;port=3307;dbname=rent_stats_db",
"username" => "anjuke_triger",
"password" => "anjuke_triger",
"init_attributes" => array(),
"init_statements" => array("SET CHARACTER SET utf8","SET NAMES utf8"),
...
"dsn"=>"mysql:host=10.20.3.80;port=3306;dbname=aah_dw_stats",
"username" => "readonly_v2",
"password" => "aNjuKe9dx1Pdw",
"init_attributes" => array(),
"init_statements" => array("SET CHARACTER SET utf8","SET NAMES utf8"),
...
"dsn"=>"mysql:host=10.20.3.80;port=3306;dbname=user_db",
"username" => "readonly_v2",
"password" => "aNjuKe9dx1Pdw",
"init_attributes" => array(),
"init_statements" => array("SET CHARACTER SET utf8","SET NAMES utf8"),
...
"dsn"=>"mysql:host=10.20.3.80;port=3307;dbname=rent_zufang_db",
"username" => "anjuke_triger",
"password" => "anjuke_triger",
"init_attributes" => array(),
"init_statements" => array("SET CHARACTER SET utf8","SET NAMES utf8"),
