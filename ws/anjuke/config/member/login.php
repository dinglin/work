...
require_once(dirname(__FILE__) . '/../dev_user.php');
...
$config['uc_url'] = 'http://member.'.$GLOBALS['dev_user'].'.dev.anjuke.com';
...
$config['ext_login_redirect_url'] = "http://my.{$GLOBALS['dev_user']}.dev.anjuke.com/member/modify/info/";
$config['member_verifys'] = array(
    ...
    'haozu'=> "http://www.{$GLOBALS['dev_user']}.dev.haozu.com/verify",
    #    'anjuke-bbs'=>'http://my.anjuke.com/v2/user/verify',
    'anjuke'=>"http://my.{$GLOBALS['dev_user']}.dev.anjuke.com/user/verify",
    'jinpu'=>"http://my.{$GLOBALS['dev_user']}.dev.jinpu.com/verify",
);

$config['member_logout'] = array(
    //'modbbs'=>'http://modbbs.anjuke.com/logout',
    //'bbscp'=>'http://bbscp.anjuke.com/group/logout',
    'haozu' => "http://www.{$GLOBALS['dev_user']}.haozu.com/logout",
...
/*** nlogger 记录登录注册统计数据*/
$config['tag_name'] = "test_register_login";